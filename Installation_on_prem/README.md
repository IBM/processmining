...
In this document, we install Process Mining and Task Mining in two independent virtual machines. We can install both process mining and task mining in the same virtual machine, some configurations are different.
